...
export function ClienteMensagensTab() {
  const [mensagens, setMensagens] = useState([
    { id: '1', texto: 'Olá! Gostaria de tirar uma dúvida sobre o desenho.', autor: 'eu', horario: '14:20' },
    { id: '2', texto: 'Oi! Claro, pode mandar a referência que ajustamos.', autor: 'tatuador', horario: '14:22' },
  ]);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.chatHeader}>
        ...
        <View>
          <Text style={styles.chatName}>Camila Rossi (Brasa Studio)</Text>
